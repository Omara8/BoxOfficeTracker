...
import com.planatech.bo.tracker.utils.stateviews.ProgressLayout
import java.util.*

class ProgressMotionLayout : MotionLayout, ProgressLayout {
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        loadingStateProgressBarColor = typedArray.getColor(
            R.styleable.ProgressActivity_loadingProgressBarColor,
            Color.parseColor("#0076BF")
        )
    ...
    private fun switchState(
        ...
        when (state) {
            ...
            ERROR -> {
                ...
                if (buttonText == null) {
                    errorStateButton!!.visibility = INVISIBLE
                } else {
